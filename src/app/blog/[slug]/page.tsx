        ...
        <div className="grid gap-px bg-gray-900/50 border border-gray-900/50 overflow-hidden rounded-3xl">
          {posts.map((post) => (
            <Link 
              key={post.slug} 
              href={`/blog/${post.slug}`} 
              className="group relative block bg-black p-10 md:p-16 transition-all duration-500 hover:bg-[#050505] z-10"
            >
              <div className="flex flex-col gap-8 pointer-events-none">
                ...
                {/* Buton alanı artık sadece görsel, tıklama Link üzerinden dönüyor */}
